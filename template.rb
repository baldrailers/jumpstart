...
def add_users
  ...
  inject_into_file 'config/initializers/devise.rb', "  config.navigational_formats = ['/', :html, :turbo_stream]",
...
def add_action_text
  ...
  insert_into_file 'app/assets/stylesheets/application.bootstrap.scss', '@import "trix/dist/trix";'
end
...
after_bundle do
  ...
  say
  say '  # Update app/javascript/application.js to activate trix'
  say
  say '  bin/dev'
end
